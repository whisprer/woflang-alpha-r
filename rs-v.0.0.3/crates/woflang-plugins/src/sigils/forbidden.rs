...
pub fn register(interp: &mut Interpreter) {
    ...
    interp.register("void_division", |interp| {
        ...
        let dividend_val = match dividend {
    ...
    interp.register("resurrect", |interp| {
        ...
        interp.stack_mut().push(WofValue::Float(PI));   // π
        interp.stack_mut().push(WofValue::Float(e));    // e
        interp.stack_mut().push(WofValue::Float(phi));  // φ
